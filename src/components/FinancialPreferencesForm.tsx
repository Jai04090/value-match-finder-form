...
const FinancialPreferencesForm = () => {
  ...
  const religiousOrganizations = ['Catholic', 'Evangelical', 'Pentacostal/Assembly of God', 'Lutheran', 'Seventh-day Adventist', 'Mennonite', 'Islam', 'Jewish', 'Hindu', 'Sharia-Compliant (Interest-Free Banking)', 'Other'];
  ...
  const handleInputChange = (field: keyof FormData, value: string | boolean) => {
    setFormData(prev => ({
      ...
      ...(field === 'currentOrFormerMilitary' && value === 'No' ? {
        militaryBranch: ''
      } : {})
    }));
  };
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Input id="currentFinancialInstitution" type="text" placeholder="e.g., Chase Bank, Wells Fargo, Local Credit Union" value={formData.currentFinancialInstitution} onChange={e => handleInputChange('currentFinancialInstitution', e.target.value)} className="w-full" />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Textarea id="lookingFor" placeholder="Describe your priorities, such as low fees, ethical practices, community involvement, specific services, etc." value={formData.lookingFor} onChange={e => handleInputChange('lookingFor', e.target.value)} className="w-full min-h-[100px] resize-y" />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Select value={formData.religiousOrganization} onValueChange={value => handleInputChange('religiousOrganization', value)}>
                  <SelectTrigger className="w-full">
                    <SelectValue placeholder="Select your religious organization" />
                  </SelectTrigger>
                  <SelectContent className="bg-white border shadow-lg">
                    {religiousOrganizations.map(org => <SelectItem key={org} value={org} className="hover:bg-gray-100">
                        {org}
                      </SelectItem>)}
                  </SelectContent>
                </Select>
              ...
              <div className="space-y-2">
                ...
                <Input id="currentEmployer" type="text" placeholder="e.g., Microsoft, Local School District, Self-employed" value={formData.currentEmployer} onChange={e => handleInputChange('currentEmployer', e.target.value)} className="w-full" />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input id="studentOrAlumni" type="text" placeholder="e.g., University of Michigan, Harvard Business School, Currently at UCLA" value={formData.studentOrAlumni} onChange={e => handleInputChange('studentOrAlumni', e.target.value)} className="w-full" />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Select value={formData.currentOrFormerMilitary} onValueChange={value => handleInputChange('currentOrFormerMilitary', value)}>
                  <SelectTrigger className="w-full">
              ...
              {formData.currentOrFormerMilitary === 'Yes' && <div className="space-y-2 animate-in slide-in-from-top-2 duration-200">
                  ...
                  <Select value={formData.militaryBranch} onValueChange={value => handleInputChange('militaryBranch', value)}>
                    ...
                    <SelectContent className="bg-white border shadow-lg">
                      {militaryBranches.map(branch => <SelectItem key={branch} value={branch} className="hover:bg-gray-100">
                          {branch}
                        </SelectItem>)}
                    </SelectContent>
                  </Select>
              ...
              <div className="flex items-center space-x-2">
                <Checkbox id="environmentalInitiatives" checked={formData.environmentalInitiatives} onCheckedChange={checked => handleInputChange('environmentalInitiatives', checked as boolean)} />
              ...
              <div className="flex items-center space-x-2">
                <Checkbox id="diversityEquityInclusion" checked={formData.diversityEquityInclusion} onCheckedChange={checked => handleInputChange('diversityEquityInclusion', checked as boolean)} />
              ...
              <div className="space-y-2">
                ...
                <Select value={formData.religion} onValueChange={value => handleInputChange('religion', value)}>
                  ...
                  <SelectContent className="bg-white border shadow-lg">
                    {religions.map(religion => <SelectItem key={religion} value={religion} className="hover:bg-gray-100">
                        {religion}
                      </SelectItem>)}
                  </SelectContent>
                </Select>
